...
public class SearchResultFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initViews(View v){
        ...
        refreshSearch = v.findViewById(R.id.refresh_search);
        refreshSearch.setOnRefreshListener(this);


    }

    // TODO: Rename method, update argument and hook method into UI event
    public void onButtonPressed(Cagnotte c) {
        if (mListener != null) {
            mListener.onListFragmentInteraction(c);
        }
    }
    ...
    private void setRecyclerViewAdapter(RecyclerView view){
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new MyCagnotteRecyclerViewAdapter(MainActivity.searchList, mListener));
        }
    }
